# Run report: 20260702-221614-290053_tif_M08

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/290053_M08.png` (703x504)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M08 | 0,0,703,504 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 100 | 0 | 0.907 | 1.000 | 0.971 | s_alpha |
...
- QC: **ok** The red curve accurately tracks the top boundary of the hand-drawn curve across the entire image.
