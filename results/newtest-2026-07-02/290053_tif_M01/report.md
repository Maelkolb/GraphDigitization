# Run report: 20260702-221429-290053_tif_M01

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/290053_M01.png` (706x579)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M01 | 0,0,706,579 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 100 | 0 | 0.898 | 1.000 | 0.968 | s_alpha |
...
- QC: **ok** The extracted curve follows the hand-drawn line very closely within one grid tick.
