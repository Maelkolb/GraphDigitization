# Run report: 20260702-031028-290022_tif_M03

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/290022_M03.png` (708x686)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M03 | 0,0,708,686 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 98 | 0 | 0.890 | 0.968 | 0.944 | s_alpha |

## Series

### p01
- csv: `series/p01.csv` (31 samples, 1 gaps, baseline off)
- confidence chain: panel=1.00, calibration=1.00, extraction=0.89, coverage=0.97
...
| warning | series | p01 | 1 empty slice(s): 1844-03-31 |
