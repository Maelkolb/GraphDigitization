# Run report: 20260702-030955-210018_tif_M09

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/210018_M09.png` (701x526)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M09 | 0,0,701,526 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 99 | 0 | 0.926 | 1.000 | 0.977 | s_alpha |
