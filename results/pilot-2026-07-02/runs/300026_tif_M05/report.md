# Run report: 20260702-031142-300026_tif_M05

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/300026_M05.png` (712x403)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M05 | 0,0,712,403 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 100 | 0 | 0.838 | 1.000 | 0.950 | s_alpha |

## Series

### p01
- csv: `series/p01.csv` (31 samples, 0 gaps, baseline off)
- confidence chain: panel=1.00, calibration=1.00, extraction=0.84, coverage=1.00
