# Run report: 20260702-031022-290022_tif_M02

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/290022_M02.png` (680x1028)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M02 | 0,0,680,1028 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 95 | 0 | 0.890 | 1.000 | 0.966 | s_alpha |
