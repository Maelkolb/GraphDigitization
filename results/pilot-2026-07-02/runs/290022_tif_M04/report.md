# Run report: 20260702-031033-290022_tif_M04

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/290022_M04.png` (683x388)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M04 | 0,0,683,388 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 99 | 0 | 0.928 | 1.000 | 0.978 | s_alpha |
