# Run report: 20260702-031120-300026_tif_M01

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/300026_M01.png` (714x472)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M01 | 0,0,714,472 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 99 | 0 | 0.849 | 1.000 | 0.953 | s_alpha |

## Series

### p01
- csv: `series/p01.csv` (31 samples, 0 gaps, baseline off)
- confidence chain: panel=1.00, calibration=1.00, extraction=0.85, coverage=1.00
