# Run report: 20260702-030936-210018_tif_M05

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/210018_M05.png` (711x338)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M05 | 0,0,711,338 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 91 | 0 | 0.922 | 1.000 | 0.976 | s_alpha |
