# Run report: 20260702-031000-210018_tif_M10

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/210018_M10.png` (715x306)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M10 | 0,0,715,306 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 98 | 0 | 0.890 | 1.000 | 0.966 | s_alpha |
