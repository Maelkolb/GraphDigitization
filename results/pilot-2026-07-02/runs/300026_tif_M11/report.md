# Run report: 20260702-031213-300026_tif_M11

- profile: **danube**
- graphdig: 0.1.0
- input: `pages/300026_M11.png` (697x414)

## Panels

| panel | label | bbox (x,y,w,h) | conf | flags |
|---|---|---|---|---|
| p01 | M11 | 0,0,697,414 | 1.00 | seeded_from_annotations |
...
|---|---|---|---|---|---|---|
| p01 | 91 | 1 | 0.823 | 1.000 | 0.945 | s_alpha |
